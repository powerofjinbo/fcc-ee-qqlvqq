#!/usr/bin/env python3
"""Draw the v_fable paper-style event-selection and cutflow summary figure."""
...
def draw_cutflow_table(ax, yields: dict[str, list[float]]) -> None:
    ...
    ax.text(
        0.5,
        0.022,
        r"Nominal baseline ends at Cut6. $m_{Z,\rm cand}$, $p_{Z,\rm cand}$, $m_{H,\rm cand}$ and recoil mass are BDT inputs, not hard filters.",
        ha="center",
        va="center",
        fontsize=10.5,
        color="#333333",
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--version", default="v_fable")
